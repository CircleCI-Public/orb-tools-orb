...
function publishOrb() {
  #$1 = full tag
  circleci orb publish --host "${CIRCLE_API_HOST:-https://circleci.com}" --skip-update-check "${ORB_PARAM_ORB_DIR}/orb.yml" "${ORB_PARAM_ORB_NAME}@${1}" --token "$ORB_PARAM_ORB_PUB_TOKEN"
  printf "\n"
  {
